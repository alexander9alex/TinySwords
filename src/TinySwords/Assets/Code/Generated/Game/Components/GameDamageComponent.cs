...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Units.Damage damage { get { return (Code.Gameplay.Features.Units.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Units.Damage)CreateComponent(index, typeof(Code.Gameplay.Features.Units.Damage));
