...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Units.CurrentHp currentHp { get { return (Code.Gameplay.Features.Units.CurrentHp)GetComponent(GameComponentsLookup.CurrentHp); } }
    ...
    public GameEntity AddCurrentHp(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Units.CurrentHp)CreateComponent(index, typeof(Code.Gameplay.Features.Units.CurrentHp));
