...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Sounds.Volume volume { get { return (Code.Gameplay.Features.Sounds.Volume)GetComponent(GameComponentsLookup.Volume); } }
    ...
    public GameEntity AddVolume(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Sounds.Volume)CreateComponent(index, typeof(Code.Gameplay.Features.Sounds.Volume));
