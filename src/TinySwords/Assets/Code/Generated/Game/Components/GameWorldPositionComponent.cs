...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Move.WorldPosition worldPosition { get { return (Code.Gameplay.Features.Move.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Gameplay.Features.Move.WorldPosition)CreateComponent(index, typeof(Code.Gameplay.Features.Move.WorldPosition));
