...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Units.Speed speed { get { return (Code.Gameplay.Features.Units.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Units.Speed)CreateComponent(index, typeof(Code.Gameplay.Features.Units.Speed));
