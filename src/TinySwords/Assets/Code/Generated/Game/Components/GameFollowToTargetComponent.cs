...
public partial class GameEntity {
    ...
    static readonly Code.Gameplay.Features.AttackIndicator.FollowToTarget followToTargetComponent = new Code.Gameplay.Features.AttackIndicator.FollowToTarget();
