...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Units.MaxHp maxHp { get { return (Code.Gameplay.Features.Units.MaxHp)GetComponent(GameComponentsLookup.MaxHp); } }
    ...
    public GameEntity AddMaxHp(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Units.MaxHp)CreateComponent(index, typeof(Code.Gameplay.Features.Units.MaxHp));
