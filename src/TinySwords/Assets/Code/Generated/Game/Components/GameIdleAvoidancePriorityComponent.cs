...
public sealed partial class GameMatcher {
    ...
    static Entitas.IMatcher<GameEntity> _matcherIdleAvoidancePriority;

    public static Entitas.IMatcher<GameEntity> IdleAvoidancePriority {
        get {
            if (_matcherIdleAvoidancePriority == null) {
                var matcher = (Entitas.Matcher<GameEntity>)Entitas.Matcher<GameEntity>.AllOf(GameComponentsLookup.IdleAvoidancePriority);
                matcher.componentNames = GameComponentsLookup.componentNames;
                _matcherIdleAvoidancePriority = matcher;
            }

            return _matcherIdleAvoidancePriority;
        }
    }
}
...
public partial class GameEntity {
    ...
    public GameEntity RemoveIdleAvoidancePriority() {
        RemoveComponent(GameComponentsLookup.IdleAvoidancePriority);
        return this;
    }
}
